...
const STR = {
  fr: {
    ...
    home_title: 'PsyNova — Infrastructure opérationnelle modulaire',
    home_lead:
      'Un seul moteur, plusieurs surfaces professionnelles : accueil, réservation, facturation, rappels, CRM, sessions, CMS et coordination configurable.',
    ...
    contact_lead: 'Ce formulaire sert à prévisualiser le routage de contact. Ne pas utiliser en cas d’urgence.',
    contact_name: 'Nom',
    contact_email: 'Courriel',
    contact_msg: 'Message',
    contact_send: 'Envoyer',
    contact_sent: 'Aperçu de routage seulement — ne pas envoyer d’information urgente ou clinique.',
    legal_title: 'Avis légaux et éthique (brouillon)',
    admin_title: 'Tableau de bord admin (simulation)',
    admin_lead: '[DRAFT] Aperçu du tableau opérationnel. Non connecté à une clinique active.',
    msgs_title: 'Messagerie sécurisée (simulée)',
    msgs_lead: '[DRAFT] Aperçu de messagerie sécurisée — ne constitue pas un dossier clinique.',
    back_home: '← Accueil',
    lang_label: 'Langue',
    sidebar_dashboard: 'Tableau de bord',
    sidebar_appts: 'Rendez-vous',
    sidebar_messages: 'Messagerie [DRAFT]',
    sidebar_telehealth: 'Télésanté',
    sidebar_billing: 'Facturation',
    sidebar_ehr: 'Dossiers cliniques',
    sidebar_clinician: 'Espace clinicien',
    sidebar_admin: 'Admin [DRAFT]',
  ...
  en: {
    ...
    home_title: 'PsyNova — Modular Operational Infrastructure',
    home_lead:
      'One engine. Many professional surfaces. Configurable intake, booking, billing, reminders, CRM, sessions, CMS, and coordination workflows.',
    ...
    blog_read: 'Read',
    contact_title: 'Contact',
    contact_lead: 'This form is for contact-routing preview only. Do not use it for emergencies.',
    contact_name: 'Name',
    contact_email: 'Email',
    contact_msg: 'Message',
    contact_send: 'Send',
    contact_sent: 'Routing preview only — do not send urgent or clinical information.',
    legal_title: 'Legal & ethics (draft)',
    admin_title: 'Admin dashboard (simulated)',
    admin_lead: '[DRAFT] Operational dashboard preview. Not connected to a live clinic.',
    msgs_title: 'Secure messaging (simulated)',
    msgs_lead: '[DRAFT] Secure messaging preview — not a clinical record.',
    back_home: '← Home',
    lang_label: 'Language',
    sidebar_dashboard: 'Dashboard',
    sidebar_appts: 'Appointments',
    sidebar_messages: 'Messaging [DRAFT]',
  ...
  es: {
    ...
    nav_api: 'API',
    nav_book: 'Reservar',
    home_title: 'PsyNova — Infraestructura operativa modular',
    home_lead:
      'Un solo motor, muchas superficies profesionales: admisión, agenda, cobros, recordatorios, CRM, sesiones, CMS y coordinación configurable.',
    ...
    contact_lead: 'Este formulario muestra el flujo de contacto. No usar en emergencias.',
    contact_name: 'Nombre',
    contact_email: 'Correo',
    contact_msg: 'Mensaje',
    contact_send: 'Enviar',
    contact_sent: 'Vista previa de enrutamiento — no enviar información urgente o clínica.',
    legal_title: 'Avisos legales (borrador)',
    admin_title: 'Panel admin (simulado)',
    admin_lead: '[DRAFT] Vista del panel operativo. No conectado a una clínica activa.',
    msgs_title: 'Mensajería segura (simulada)',
    msgs_lead: '[DRAFT] Vista de mensajería segura — no constituye expediente clínico.',
    back_home: '← Inicio',
    lang_label: 'Idioma',
    sidebar_dashboard: 'Panel',
    sidebar_appts: 'Citas',
    sidebar_messages: 'Mensajería [DRAFT]',
