...
async function bootstrap() {
  ...
  // Capture the raw request body alongside parsed JSON so the Stripe webhook handler
  // can verify `stripe-signature`. Negligible memory cost because the limit is 5MB.
  app.use(
    json({
      limit: '5mb',
